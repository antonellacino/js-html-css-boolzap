$(document).ready(function() {
    ...
    function sendMessage(message) {
        ...
        var context = { "sendReceipt": "sendMsg", "deleteRight": "deleteRight", "msg": msg, "time": time, };
        var html = template(context);
        $('.view ul.messagesList').append(html);
    ...
    function receiptMessage() {
        ...
        var source = $('#message-template').html();
        var template = Handlebars.compile(source);
        var context = { "sendReceipt": "receiptMsg", "deleteRight": "none", "msg": "ok", "time": time };
        var html = template(context);
        $('.view ul.messagesList').append(html);
